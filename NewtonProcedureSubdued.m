function [ xFinal ] = NewtonProcedureSubdued( fun, x0, h, sigma, q, tol, maxiter, plt, range)
% Name:         Subdued local Newton-Procedure
...
tic
% Loop for the subdued newton procedure
...
if counter == maxiter
    ...
    disp('Newteon procedure subdued completed!')
    counter
    Norm = norm(dx)
end
